...
Please explain React concepts with beginner-friendly examples.
...
I am trying to get the frontend running locally.
...
- Building the Customer Compass UI
- Connecting frontend to backend API routes
- Deploying to Vercel

## First Copilot Prompt to Use

> Read `PROJECT_CONTEXT.md`. I am the frontend lead for Customer Compass. Help me inspect this repository, determine whether Next.js is already set up, and tell me exactly what commands I should run next.
